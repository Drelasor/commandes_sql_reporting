...
-- $Revision: 235 $
-- $Author: be323352 $
-- $Date: 2017-11-17 10:58:27 +0100 (vr, 17 nov 2017) $
-- $HeadURL: http://146.122.121.31/RnDSUITE/00_Unilab_BackPack/Reporting/RnDSuite%20SSRS%20Reporting/RndSuite%20Reports/Interspec%20SQLServer/Data%20sets/DS_SPECDATA_FOR_SPEC.rsd $
---------------------------------------------------------------------------------------------------
...
spii.SP, spii.SP_VERSION,
  ...
  from RndSuite.RndvRepSpIi spii inner join RndSuite.RndvSp sp on spii.SP= sp.SP and spii.SP_VERSION = sp.SP_VERSION
