...
--INSERT [RndSuite].[RndtRpCmdArg] ([RP], [VERSION], [ARGUMENT], [VALUE_TP], [VALUE], [CF], [CF_VERSION])
--VALUES (CAST(1 AS Numeric(12, 0)), CAST(1.0000 AS Numeric(12, 4)), N'p_SC', N'D', N'Sample.SampleId[]', NULL, NULL)
-- INSERT [RndSuite].[RndtRpCmdArg] ([RP], [VERSION], [ARGUMENT], [VALUE_TP], [VALUE], [CF])
-- VALUES (CAST(2 AS Numeric(12, 0)), CAST(1.0000 AS Numeric(12, 4)), N'p_SP', N'D', N'Specification.SpecificationId[]', NULL)
