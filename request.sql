...
sp.SP, spii.II_SHORT_DESC, spii.DSP_TITLE, spii.IIVALUE, ppsgRow.DESCRIPTION
...
join RndSuite.RndtSpIiPpsgCell as ppsgCell on ppsgCell.SP = sp.SP and ppsgCell.SP_VERSION = sp.SP_VERSION and ppsgCell.IINODE = spii.IINODE
join RndSuite.RndtSpIiPpsgRow as ppsgRow on ppsgRow.SP = sp.SP and ppsgRow.SP_VERSION = sp.SP_VERSION and ppsgRow.IINODE = spii.IINODE




where form.RQ = 230 and spii.II_SHORT_DESC like 'MDD_assigned_PF'