...
client.DESCRIPTION,
  ...
  left join RndSuite.RndtSpIiPpsgCell cellmat on ppsg_rowmat.SP = cellmat.SP and cellmat.SP_VERSION = ppsg_rowmat.SP_VERSION and ppsg_rowmat.IC = cellmat.IC and ppsg_rowmat.ICNODE = cellmat.ICNODE and ppsg_rowmat.IINODE = cellmat.IINODE and cellmat.PR_SEQ = ppsg_rowmat.PR_SEQ
  ...
  where rq.RQ = 562 and spiimat.II_SHORT_DESC = 'Customer_PPSG' and e.DISP_TITLE like 'Quality Comments'